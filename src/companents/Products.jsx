    ...
    <div className="w-[80%] py-3 px-4">
      <div className="w-full flex ">
        {selected.map((select, id) => {
          return (
            <div className="flex items-center justify-evenly bg-white rounded-lg border mx-1 px-4 border-[#BBBBBB]">
              <h3
                className="text-black text-xs font-semibold text-center py-[10px]"
                key={id}
              >
                {select}
              </h3>
