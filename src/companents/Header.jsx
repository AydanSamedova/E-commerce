  ...
  return (
    <div className="w-full py-2 px-5">
      <div className="flex items-center ">
        <h2 className="text-4xl text-red font-extrabold w-32">LOGO</h2>
        <div className="flex items-center ">
          <span className="text-sm  mx-6 ">Mağazanı yarat</span>
          ...
          <div className="flex items-center text-sm mx-10">
            ...
            <div className="flex items-center"><span>TRY </span><i className="fa-solid fa-chevron-down mx-1" style={{fontSize:'0.55rem'}}></i></div>
